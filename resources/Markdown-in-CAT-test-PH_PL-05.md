---
title: Output test file — Phrase, Exclude code elements
layout: default
nav_exclude: true
---
...
- ___``Basic` [Markdown](https://en.wikipedia.org/wiki/Markdown "Spoko, c’nie?") Składnia :sweat_smile:___
